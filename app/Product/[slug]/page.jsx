...
export default function ProductDetailsPage() {
  ...
  const handleColorSelect = (color) => {
    ...
    // Directly use color.image from MongoDB
    if (color.image) {
      setSelectedColorImage(color.image);

      // If the color image is also inside product.images,
      // select that thumbnail too.
      ...
      // If this color has no image,
      // fallback to normal product gallery.
      setSelectedColorImage("");
    }
  };
            ...
            <div className="relative aspect-square w-full rounded-2xl border border-gray-100 bg-gray-50 flex items-center justify-center overflow-hidden">
              ...
              {mainImage ? (
                <img
                  ...
                  className="w-full h-full object-contain p-6 md:p-8 transition-all duration-300"
                />
              ) : (
                ...
                {images.map((image, index) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      // User manually selected gallery image,
                      // so remove color-specific image.
                      setSelectedColorImage("");
                    }}
                    className={`
